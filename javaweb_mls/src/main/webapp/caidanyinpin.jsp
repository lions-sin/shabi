                                    ...
                                    <ul class="secondary-menu">
                                        ...
                                        <c:forEach var="fs" items="${requestScope.foodStyleList}">
                                            ...
                                            <li class="secondary-menu-item ">
                                                <a class="secondary-menu-item-target" href="food?todo=selectFoodByfoodStyleId&foodStyleId=${fs.foodStyleId}"><i class="fa fa-circle"></i> <span>${fs.foodStyleName}</span></a>
                                            </li>
                                        </c:forEach>
